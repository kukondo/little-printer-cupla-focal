...
get '/edition/' do
  ...
  if response.success?
    ...
    @example = Sanitize.clean(latest_word.at_css("description").text)
...
get '/sample/' do
  ...
  @example = "celeste (seh-leh'-steh) adjective: Te queda mejor el vestido celeste para la fiesta. - The sky-blue dress looks better on you for the party."
